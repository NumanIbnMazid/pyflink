...
class UserSessionFunction(AggregateFunction):
    def create_accumulator(self) -> UserActivity:
        return UserActivity()

    def add(self, value, user_activity: UserActivity) -> UserActivity:
    ...
    def get_result(self, user_activity: UserActivity) -> UserActivity:
        return user_activity
...
if __name__ == '__main__':
    ...
    data_stream = env.from_collection([
        ...
        {"id": 4, "user": "numan", "timestamp": 2},
        {"id": 5, "user": "sunny", "timestamp": 3},
        {"id": 6, "user": "sunny", "timestamp": 4},
        {"id": 7, "user": "numan", "timestamp": 4},
        {"id": 8, "user": "sunny", "timestamp": 6},
        {"id": 9, "user": "sunny", "timestamp": 9},
        {"id": 10, "user": "numan", "timestamp": 9},
    ])
